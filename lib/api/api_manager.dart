...
import 'package:news_api/api/model/NewRelasesResponce.dart';
...
class ApiManager {
  ...
  static Future<MoviesPopularResponce>
      getMoviePopular() async // 1- GET /movie/popular
  {
  ...
  static Future<RecomendedResponce>
      getRecomendedResponse() async // - 3/movie/top_rated
  {
    var uri = Uri.https(Base_URL, '3/movie/top_rated', {'api_key': APIKey});
    var responce = await http.get(uri);
    var responceBody = responce.body;
    var json = jsonDecode(responceBody);
    var recomendedR = RecomendedResponce.fromJson(json);
    return recomendedR;
  }
  static Future<NewRelasesResponce>
  getNewRelasesResponce() async // - /movie/popular
      {
    var uri = Uri.https(Base_URL, '3/movie/popular', {'api_key': APIKey});
    var responce = await http.get(uri);
    var responceBody = responce.body;
    var json = jsonDecode(responceBody);
    var newRelasesResponceR = NewRelasesResponce.fromJson(json);
    return newRelasesResponceR;
  }
}
